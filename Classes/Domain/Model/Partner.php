...
class Partner extends AbstractEntity implements GetCategoryCollectionInterface
{
     ...
     * renders an empty map centred on Germany - and before ACE-708 taught the module to
     * refuse the pair, a marker at 0/0 off the coast of Africa.
     *
     ...
     * query lets it through. Changing the columns to a numeric type is where the two would be
     * reconciled; on the 3.x line that is tracked as ACE-566, and neither branch has done it.
     */
