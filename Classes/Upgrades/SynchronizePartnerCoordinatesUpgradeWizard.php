...
/**
 * The partner coordinates became `allowLanguageSynchronization` (ACE-709), because a
 ...
 * ACE-708 taught the module to refuse the pair left it out of the map altogether, while
 * the default record held perfectly good coordinates.
 *
