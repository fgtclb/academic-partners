...
:yaml:`fgtclb/academic-partners` shipped its own :file:`constants.typoscript`
...
*   :file:`Configuration/TypoScript/` keeps the shared
    :typoscript:`plugin.tx_academicpartners` block and the :typoscript:`page`
...
*   :file:`Configuration/TypoScript/List/`,
    :file:`Configuration/TypoScript/Map/`,
    :file:`Configuration/TypoScript/PartnershipsList/` and
    :file:`Configuration/TypoScript/PartnershipsTeaser/` are the four component
...
:file:`Configuration/page.tsconfig` removes all four content element types from
...
:guilabel:`AcademicPartner` are unchanged and stay installation-wide. They are
...
The set :yaml:`fgtclb/academic-partners` keeps its name and keeps delivering
...
..  list-table::
    ...
    *   -   `EXT:academic_partners/Configuration/TypoScript/Content/ContentLoad.typoscript`
        -   `EXT:academic_partners/Configuration/TypoScript/ContentLoad/setup.typoscript`
    *   -   `EXT:academic_partners/Configuration/TypoScript/Content/`
        -   `EXT:academic_partners/Configuration/TypoScript/ContentLoad/`
    *   -   `EXT:academic_partners/Configuration/TsConfig/Wizards/NewContentElement.tsconfig`
        -   `EXT:academic_partners/Configuration/TSconfig/Full/page.tsconfig`
    *   -   `EXT:academic_partners/Configuration/TsConfig/Wizards/*.tsconfig`
        -   `EXT:academic_partners/Configuration/TSconfig/Full/page.tsconfig`
    *   -   `EXT:academic_partners/Configuration/TsConfig/BackendLayouts/AcademicPartner.tsconfig`
        -   `EXT:academic_partners/Configuration/TSconfig/BackendLayouts/AcademicPartner.tsconfig`
    *   -   `EXT:academic_partners/Configuration/TsConfig/BackendLayouts/*.tsconfig`
        -   `EXT:academic_partners/Configuration/TSconfig/BackendLayouts/*.tsconfig`
    *   -   `EXT:academic_partners/Configuration/Sets/AcademicPartners/constants.typoscript`
        -   Removed. It was a one-line :typoscript:`@import` of the file above
            it in this table.
    *   -   `EXT:academic_partners/Configuration/Sets/AcademicPartners/setup.typoscript`
...
..  list-table::
    ...
    *   -   Old entry
        -   New entry
    *   -   :guilabel:`Academic Partners Page Setup (academic_partners)`,
            stored as `EXT:academic_partners/Configuration/TypoScript/`
        -   :guilabel:`Academic Partners: Shared plugin settings and page
            rendering (academic_partners)`, same stored value — or
            :guilabel:`Academic Partners: All components (academic_partners)`,
            stored as `EXT:academic_partners/Configuration/TypoScript/Full`,
...
:guilabel:`Academic Partners: All components (academic_partners)`, stored as
...
..  list-table::
    ...
    *   -   `fgtclb/academic-partners-list`
        -   The :guilabel:`Partners List` content element only.
    *   -   `fgtclb/academic-partners-map`
        -   The :guilabel:`Partners Map` content element only.
    *   -   `fgtclb/academic-partners-partnerships-list`
        -   The :guilabel:`Partnerships List` content element only.
    *   -   `fgtclb/academic-partners-partnerships-teaser`
        -   The :guilabel:`Partnerships Teaser` content element only.
...
..  index:: TypoScript, TSConfig, Backend, ext:academic_partners
