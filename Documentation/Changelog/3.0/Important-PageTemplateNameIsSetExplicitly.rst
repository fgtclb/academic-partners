...
:typoscript:`pagets__AcademicPartner` therefore resolved to :file:`Academicpartner.html`, and
...
object. An installation that shipped :file:`Academicpartner.html` in its own site
