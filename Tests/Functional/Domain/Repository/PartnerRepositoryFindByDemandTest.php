...
final class PartnerRepositoryFindByDemandTest extends AbstractAcademicPartnersTestCase
{
     ...
     * resolved it, on the 3.x line differently between two calls on PostgreSQL (ACE-491).
     * The `uid` tiebreaker settles it, in the middle of an otherwise title-ordered list.
     * The tied records' `sorting` values are deliberately reversed against uid order, so a
