 ...
 * the set based one asserts: the shared `plugin.tx_academicpartners` block arrives through every
 ...
 */
final class StaticTemplateDeliveryTest extends AbstractAcademicPartnersTestCase
{
    ...
    {
        $this->setUpSite(includeStaticFile: 'EXT:academic_partners/Configuration/TypoScript/' . $component);
    ...
    {
        yield 'aggregate static template' => ['EXT:academic_partners/Configuration/TypoScript/Full', true];
        yield 'content load static template' => ['EXT:academic_partners/Configuration/TypoScript/ContentLoad', true];
        yield 'component static template alone' => ['EXT:academic_partners/Configuration/TypoScript/List', false];
        yield 'stored shared static template' => ['EXT:academic_partners/Configuration/TypoScript/', false];
    ...
    {
        $this->setUpSite(tsConfigIncludes: 'EXT:academic_partners/Configuration/TSconfig/Full/page.tsconfig');
